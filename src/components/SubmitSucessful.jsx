      ...
      <div className="fixed inset-0 flex justify-center items-center z-50 ml-55">
        <div className="flex flex-col items-center">
          ...
          <div className="bg-white shadow-lg px-10 py-15 w-full max-w-5xl text-center flex flex-col items-center relative">
            ...
            <p className="mb-4">
              Thank you for submitting your verification requirements. Your documents are now{' '}
              <span className="font-semibold"> under review</span> by our admin team.
            </p>
            <p>
              You will receive an <span className="font-semibold">email notification</span> once the
              review is complete. This process typically takes 1-3 business days.
            </p>
          </div>
        </div>
      </div>
