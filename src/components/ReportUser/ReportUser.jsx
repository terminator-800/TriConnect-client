...
const ReportUser = ({ reportedUser, conversationId, onClose, role }) => {
  ...
  return (
        ...
        <div className="mb-6">
          ...
          <div className="mt-3 bg-blue-50 border-l-4 border-blue-400 p-3">
            <p className="text-xs text-gray-700">
              <span className="font-semibold">Note:</span> Your report will be
              kept confidential. The applicant will not be notified of who
    ...
    {showSuccess && (
      <ReportSuccessfully onClose={() => setShowSuccess(false)} />
    )}
