...
//           <div
//             className={`rounded my-2 cursor-pointer ${isSelected === business ? 'bg-red-500' : 'bg-red-300'} w-60 text-center pt-60 pb-5 italic shadow-xl`}
...
//           <div
//             className={`rounded my-2 cursor-pointer ${isSelected === individual ? 'bg-blue-500' : 'bg-blue-300'} w-60 text-center pt-60 pb-5 italic shadow-xl`}
...
//           <BackButton
//             to={`/register`}
//             className="bg-white text-blue-900 pt-1 pb-1 pl-15 pr-15 rounded-3xl mt-15 text-2xl cursor-pointer border border-blue-900"
//           />
//           <button
//             onClick={() => handleNext()}
//             className="bg-blue-900 text-white pt-1 pb-1 pl-10 pr-10 rounded-3xl mt-15 text-2xl cursor-pointer"
//           >
//             Next Step
//           </button>
//         </div>
