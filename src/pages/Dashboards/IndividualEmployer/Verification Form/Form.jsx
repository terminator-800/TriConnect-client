    ...
    <div className="fixed flex items-center justify-center z-50 inset-0 backdrop-blur-sm">
      {!showSuccessModal && (
        <form
          ...
          className="relative z-10 border-2 border-gray-300 bg-white rounded-xl p-6 h-[90vh] w-full max-w-2xl overflow-y-auto hide-scrollbar"
        >
          <button
            type="button"
            onClick={onClose}
          ...
          <div className="mt-6">
            ...
            <FileUpload
              ...
              setPreview={(value) =>
                value === 'modal' ? setShowGovernmentIdModal(true) : setGovernmentIdPreview(value)
              }
              id="government_id"
              allowPreview
            />
            ...
            <FileUpload
              ...
              setPreview={(value) =>
                value === 'modal' ? setShowSelfieWithIdModal(true) : setSelfieWithIdPreview(value)
              }
              id="selfie_with_id"
              allowPreview
            />
