...
const ViewReportedUser = ({ report, onClose }) => {
  ...
  return (
    <>
        ...
        <div className="backdrop-blur-2xl max-w-3xl w-full shadow-lg p-6 relative">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p
                className={`text-sm italic font-semibold ${roleColors[report.reported_user?.role || 'N/A']}`}
              >
      ...
      <PreviewReportImage imageUrl={previewImage} onClose={() => setPreviewImage(null)} />
