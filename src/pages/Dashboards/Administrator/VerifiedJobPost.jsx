              ...
              {currentPosts.map((job) => (
                ...
                >
                  ...
                  <div className="absolute right-6 top-6 bottom-6 flex flex-col items-end justify-between">
                    <span className={`${getTypeColor(job.post_type)} px-4 py-1 rounded-full text-sm font-semibold`}>
                  ...
                  {/* ROLE + LOCATION */}
                  <p className={`text-sm italic font-bold flex items-center gap-3 mb-3 ${getRoleColor(job.role)}`}>
                  ...
                  <div className="text-sm text-gray-700 space-y-1">
                    ...
                    {job.post_type === "job_post" && (
                      ...
                      <div className="flex gap-5">
                        ...
                        <p className="max-w-4xl overflow-hidden whitespace-nowrap text-ellipsis">
                          <strong>Description:</strong> {job.job_description}</p>
                      </div>
                      </>
                    )}
                    ...
                    {job.post_type === "individual_job_post" && (
                     ...
                     <div className="flex gap-5 text-sm">
                        <p><strong>Worker Name:</strong> {job.worker_name}</p>
                        <p><strong>Category:</strong> {job.worker_category}</p>
                    ...
                    {job.post_type === "team_job_post" && (
                      ...
                      <div className="flex gap-5">
                        <p><strong>Category:</strong> {job.worker_category}</p>
                        <p><strong>Team Size:</strong> {job.number_of_workers}</p>
                        <p className="max-w-4xl overflow-hidden whitespace-nowrap text-ellipsis">
