...
const JobPostDetails = () => {
  ...
  return (
    <>
      <Sidebar />
      <div
        className="relative min-h-[140vh] bg-linear-to-b from-white to-cyan-400 pl-110 pr-50 pt-50
                      2xl:pl-110
                      2xl:pr-50
                      lg:pl-70
                      lg:pr-10
            ...
            <table className="w-full max-[769px]:min-w-max divide-y divide-gray-200 border border-gray-300 rounded-lg">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                {!isLoading && recentJobPosts.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-6 text-center bg-white text-gray-500 italic">
                      No recent job posts.
                    </td>
                  </tr>
                )}
            ...
            <table className="w-full border-collapse max-[1440px]:min-w-max">
              ...
              <tbody>
                ...
                {!isLoading && recentApplicants.length === 0 && (
                  <tr>
                    <td colSpan={4} className="py-6 text-center text-gray-500 italic bg-white">
