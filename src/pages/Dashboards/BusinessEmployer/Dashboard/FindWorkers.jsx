...
const FindWorkers = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-gray-900 mb-1">{worker.jobTitle}</h2>
      ...
      {/* Worker Detail Modal */}
      <WorkerDetailModal worker={selectedWorker} isOpen={isModalOpen} onClose={handleCloseModal} />
    </div>
  );
};
